...
const (
	dispatcherName = "kafka-channel-ingress"
)
...
func (t *DispatcherPodsLister) ListProbeTargets(ctx context.Context, kc v1beta1.KafkaChannel) (*ProbeTarget, error) {
	// TODO: fucking scope!
...
func NewProbeTargetLister(logger *zap.SugaredLogger, lister v1.EndpointsLister) ProbeTargetLister {
